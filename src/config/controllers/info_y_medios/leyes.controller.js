...
import {DB_leyes_infoymedios} from '@javascript/API/leyes.infoymedios.js'
...
export default () => {
    ...
    const popNormativa = (html, id) => {
      console.log(id)
      const longDesc = DB_leyes_infoymedios.filter(obj=> obj.ID == id)
    ...
    DB_leyes_infoymedios.forEach(element => {
          let cardHTML = `
