...
import {DB_leyes_prevencion} from '@javascript/API/leyes.prevencion.js'
...
export default () => {
    ...
    const popNormativa = (html, id) => {
      console.log(id)
      const longDesc = DB_leyes_prevencion.filter(obj=> obj.ID == id)
    ...
    DB_leyes_prevencion.forEach(element => {
          let cardHTML = `
